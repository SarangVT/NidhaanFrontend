...
export default function ImageSlider() {
  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-[65%_35%] gap-8 px-4 sm:px-8 py-6 items-center">
      <div className="relative z-0 w-full md:w-[65vw] mx-auto overflow-hidden">
        <div
      ...
      <div className="z-10 font-bold text-xl sm:text-2xl px-4 sm:px-12 lg:px-16 mt-6 lg:mt-0">
        <p className="text-green-700 font-bold animate-typingText break-words">
          #Aapka Apna Online Hospital
        </p>
        <br />
        <div>Your Health, Our Priority</div>
        <div>Lowest Delivery Time</div>
      </div>
    </div>
  );
}
