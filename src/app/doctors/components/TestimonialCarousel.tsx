...
const testimonials = [
  {
    ...
    message: "Nidhaan makes patient record management effortless. I can access histories, prescriptions, and reports in seconds.",
  },
  {
    name: "Dr. Sneha Kapoor",
    photo: "https://randomuser.me/api/portraits/women/45.jpg",
    message: "With Nidhaan, I spend more time caring for my patients and less time on tedious administrative tasks.",
  },
  {
    name: "Dr. Rahul Sharma",
    photo: "https://randomuser.me/api/portraits/men/22.jpg",
    message: "The best platform for managing my clinic! Scheduling, records, and billing are all in one place.",
  },
  {
    name: "Dr. Neha Joshi",
    photo: "https://randomuser.me/api/portraits/women/55.jpg",
    message: "Nidhaan has transformed how I work. It’s reliable, secure, and built with doctors in mind.",
  },
];
...
export default function TestimonialCarousel() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 z-10">
      <h1 className="text-5xl text-left w-full leading-loose font-bold bg-gradient-to-r from-red-600 to-pink-400 bg-clip-text text-transparent">
        Why Our Doctors Love Us ❤️
      </h1>
      <div
