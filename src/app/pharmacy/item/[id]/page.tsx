...
export default function ItemPage() {
    const [itemDetails, setItemDetails] = useState<Product | undefined>();
      ...
      const loadItemDetails = async () => {
        try {
          const { data } = await client.query({
            query: fetchItemDetails,
            variables: { productId },
          });
          if (data?.getProductDetails !== undefined) {
            setItemDetails(data.getProductDetails);
